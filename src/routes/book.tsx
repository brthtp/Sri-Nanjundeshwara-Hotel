...
export const Route = createFileRoute("/book")({
  head: () => ({
    meta: [
      { title: "Book the Venue — Sri Nanjundeshwara Hotel " },
      { name: "description", content: "Reserve a table or private venue at Sri Nanjundeshwara Hotel . Weddings, corporate evenings, and intimate celebrations." },
      { property: "og:title", content: "Book the Venue — Sri Nanjundeshwara Hotel " },
      { property: "og:description", content: "Reserve a table or private venue at Sri Nanjundeshwara Hotel , Paris." },
    ],
  }),
  component: BookPage,
});
      ...
      <section className="mx-auto grid max-w-6xl gap-10 px-6 pb-24 lg:grid-cols-[1fr_1.2fr] lg:px-10">
        ...
        >
          ...
          <div className="relative">
            <span className="text-[11px] uppercase tracking-[0.35em] text-primary">Sri Nanjundeshwara Hotel </span>
