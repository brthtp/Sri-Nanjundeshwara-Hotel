...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Sri Nanjundeshwara Hotel  — Michelin-Star Fine Dining" },
      { name: "description", content: "Sri Nanjundeshwara Hotel  is a luxury fine dining destination pairing timeless European craft with a modern Michelin-star sensibility." },
      { property: "og:title", content: "Sri Nanjundeshwara Hotel  — Michelin-Star Fine Dining" },
      { property: "og:description", content: "A timeless Michelin-star dining experience. Reserve your table or private venue at Sri Nanjundeshwara Hotel ." },
