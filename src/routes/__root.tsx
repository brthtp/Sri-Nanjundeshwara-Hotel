...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Maison Verdé — Michelin-Star Fine Dining" },
      { name: "description", content: "Maison Verdé is a luxury fine dining destination pairing timeless European craft with a modern Michelin-star sensibility." },
      { property: "og:title", content: "Maison Verdé — Michelin-Star Fine Dining" },
      { property: "og:description", content: "A timeless Michelin-star dining experience. Reserve your table or private venue at Maison Verdé." },
